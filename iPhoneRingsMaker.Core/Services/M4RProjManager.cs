...
public sealed class M4RProjManager : IM4RProjManager
{
    private string? _path;
    private M4RProj? _project;
    ...
    public async Task OpenProjectAsync(string path, CancellationToken cancellationToken = default)
    {
        ...
        var project = await JsonSerializer.DeserializeAsync<M4RProj>(stream, Json.Options, cancellationToken)
